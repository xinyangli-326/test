...
2) 若商品主题是明确 IP/IP联名（如蛋仔派对、奥特曼、奶龙、B.Duck、小黄鸭、小帅等），重点讲这个 IP 的价值——它自带的知名度、目标人群（亲子家庭/年轻人/粉丝）、话题度与社交传播力、拍照打卡属性、以及“为酒店做差异化房型、自带流量、支撑房型溢价、便于内容传播”的理由；对 IP 的知名度与人设只做定性描述（如“国民级休闲游戏、深受亲子家庭与年轻人喜爱”“IP 自带忠实粉丝与社交话题”），**禁止编造具体粉丝量、下载量、销量等数字**；商品本身没有明确 IP 时，就只写产品功能与适用场景。
